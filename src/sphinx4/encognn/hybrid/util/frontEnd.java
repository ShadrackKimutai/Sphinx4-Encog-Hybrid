 ...
 */
 ...
 /* This class is based on sphinx4 front end file dumper.
  * located in this path sphinx4-1.0beta6\src\sphinx4\edu\cmu\sphinx\tools\feature
  * it has been modified by Shadrack Kimutai IS/MPHIL/040/2010 to suit the situation and the owners rights have been preserved
  */
 ...
 */
     ...
     */
    public frontEnd(ConfigurationManager cm, String frontEndName)
            throws IOException {
        try {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            frontEnd dumper = new frontEnd (cm, frontEndName);
